...
class TieredImagenetClassDataset(ClassDataset):
    ...
    embedding_file = "tieredImagenet_embeddings.pkl"
    ...
    def __init__(self, root, meta_train=False, meta_val=False, meta_test=False,
        ...
        with open(os.path.join(self.root, self.embedding_file), 'rb') as handle:
    ...
    def __getitem__(self, index):
        ...
        task_embedding = self.embeddings[general_class_name]

        return TieredImagenetDataset(index, data,
            general_class_name, specific_class_name,
            transform=transform, target_transform=target_transform, task_embedding=task_embedding)
...
class TieredImagenetDataset(Dataset):
    def __init__(self, index, data, general_class_name, specific_class_name,
                 transform=None, target_transform=None, task_embedding=None):
    ...
    def __getitem__(self, index):
        ...
        return (image, target, self.task_embedding)
